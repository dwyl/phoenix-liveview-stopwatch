...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/dwyl/phoenix-liveview-stopwatch/ci.yml?label=build&style=flat-square&branch=main)
